...
'''
    ...
    'Soyuz-2': {
        ...
        "mass_int": 312000,
        "Years in Operation": "2004~",
        "firstyear_int": 2004,
        "Country": "Russia",
        "flag_icon": "flags/russia.png",
        "Operational Status": "Active",
        "Number of Stages": "2-3",
        "Burn Time": "Boosters: 118 sec, S1: 286 sec, S2: 270 sec, S3(Optional): 1100 sec",
        "total_burntime_int": 1744,
        "Thrust": "Boosters: 839.48 kN, S1: 792.41 kN, S2: 298 kN, S3(Optional): 19.85 kN",
        "initial_thrust_int": 1631.89,
        "ISP": "Boosters: 263.3 sec, S1: 257.7 sec, S2: 359 sec, S3(Optional): 333.2 sec",
        "asl_isp_int": 260,
        "vac_isp_int": 333,
        ...
        "Additional Information":
            '''
Soyuz-2 (GRAU index 14A14) is a modernised version of the Russian Soyuz rocket. In 
its basic form, it is a three-stage carrier rocket for placing payloads into low Earth 
orbit. Compared to the previous versions of the Soyuz, the first-stage boosters and two 
core stages feature uprated engines with improved injection systems. Digital flight 
control and telemetry systems allow the rocket to be launched from a fixed launch platform, 
whereas the launch platforms for earlier Soyuz rockets had to be rotated as the rocket 
could not perform a roll to change its heading in flight.

Soyuz-2 is often flown with an upper stage, which allows it to lift payloads into higher 
orbits, such as Molniya and geosynchronous orbits. The upper stage is equipped with 
independent flight control and telemetry systems from those used in the rest of the rocket. 
The NPO Lavochkin manufactured Fregat is the most commonly used upper stage.

Soyuz-2 rockets were first launched from Site 31 at the Baikonur Cosmodrome, and Site 43 
...
TsSKB-Progress halted production of Soyuz-U in April 2015; the final flight of a Soyuz-U rocket took 
place on 22 February 2017, carrying Progress MS-05 to the International Space Station. According to 
CNES officials interviewed in May 2018, launches of Soyuz from Guiana may be replaced by the Ariane 
6 medium-lift version A62 in 2021.

---Variants---
The Soyuz-2 family includes 2.1a, 2.1b, and 2.1v. The first two variants are modifications to the 
Soyuz-U launcher. The latter is a "light" version without side boosters.
...
engines on the booster and the first stage with improved injection systems. The new digital flight
control and telemetry systems allow the rocket to launch from a fixed rather than angled launch 
platform and adjust its heading in flight. A digital control system also enables the launch of 
larger commercial satellites with wider and longer payload fairings such as the ST-type fairing. 
These fairings introduce too much aerodynamic instability for the old analog system to handle. 
This stage continues to use the RD-0110 engine.

The 2.1a/ST version is sometimes called Soyuz ST-A. The first launch, from Guiana, (17 December 
2011 for Pléiades-HR 1A, SSOT, ELISA (4 satellites)) was a success.

Soyuz-2.1b
The 2.1b version adds an upgraded engine (RD-0124) which greatly increases the specific impulse 
of the upper stage (326 seconds to 359 seconds). First launch took place from Plesetsk Cosmodrome 
Site 43 on 26 July 2008 with a classified military payload.

The 2.1b/ST version is sometimes called Soyuz ST-B. The first launch, from Guiana, was a success 
(21 October 2011), for the first two Galileo IOV satellites.
...
'''
    ...
    "Delta III": {
        ...
        "Operational Status": "Retired",
        "Number of Stages": "2",
        "Burn Time": "Boosters: 75 sec, S1: 260 sec, S2: 700 sec, S3: 87 sec",
        "total_burntime_int": 1122,
        "Thrust": "Boosters: 628.3 kN, S1: 1,085.79 kN, S2: 110.03 kN, S3: 66.723 kN",
        "initial_thrust_int": 1714.09,
        "ISP": "Boosters: 273 sec, S1: 254 sec, S2: 462 sec, S3: 286 sec",
        "asl_isp_int": 263,
        "vac_isp_int": 286,
...
Delta Flight 280: The third and final flight on August 23, 2000 launched a 4,348 kg (9,586 lb) satellite simulator into a 180.76 × 20,694 km orbit. While the apogee was 2,710 km lower than the targeted 185 × 23,404 km, and somewhat a partial failure, it was within the allowable 3,000 km margin of error and demonstrated the propellant depletion shutdown capability of the DCSS, modified versions of which would become the second stage of the Delta IV.
    ...
    "Ariane 6": {
        ...
        "Number of Stages": "2",
        "Burn Time": "Boosters: 140 sec, S1: Unknown, S2: Unknown",
        "total_burntime_int": None,
        "Thrust": "Boosters: (2)-9,000|(4)-18,000 kN, S1: 1,370 kN, S2: 180 kN",
        "initial_thrust_int": 19370,
        "ISP": "Boosters: Unknown, S1: Unknown, S2: Unknown",
        "asl_isp_int": None,
        "vac_isp_int": None,
...
Ariane 6 comprises three major structural and propellant-carrying components.
    ...
    "Tronador II": {
        ...
        "Manufacturer": "CNAE - Comisión Nacional de Actividades Espaciales",
        "Class": "Light",
...
The Kaituozhe-2A (KT-2A) features a possibly DF-31 based stage 1, augmented by two DF-21 based strap-on boosters. It features a stage 2 with the same diameter as the stage 1 and the same smaller diameter stage 3 as the Kaituozhe-2. It has reportedly a payload of 2000 kg to low earth orbit.
    ...
    "Kuaizhou": {
        ...
        "Manufacturer": "",        
        "Class": "Light",
        "Payload Capacity to LEO": "200 kg (440 lbs)",
        "payload_int": 200,
        "Height": "19.4 m (64 ft)",
        "height_int": 19.4,
...
CAST - China Academy of Space Technology''',
        ...
        "Operational Status": "Retired",
        "Number of Stages": "3",
        "Burn Time": "S1: 130 sec, S2: 126 sec, S3: 38 sec",
        "total_burntime_int": 294,
        "Thrust": "S1: 1,214.4 kN, S2: 	320.2 kN, S3: 181 kN ",
        "initial_thrust_int": 1214.4,
...
CAST - China Academy of Space Technology
        ...
        "Manufacturer": "",        
        "Class": "Light",
        "Payload Capacity to LEO": "930 kg (2,050 lbs)",
        "payload_int": 930,
        ...
        "Operational Status": "Retired",
        "Number of Stages": "3",
        "Burn Time": "S1: 131.5 sec, S2: 365 sec, S3: 43 sec",
        "total_burntime_int": 539.5,
        "Thrust": "S1: 1,101.2 kN, S2: 98.1 kN, S3: 44 kN",
        "initial_thrust_int": 1101.2,
        "ISP": "S1: 267.4 sec, S2: 295.2 sec, S3: 289 sec",
        "asl_isp_int": 267,
        "vac_isp_int": 289,
...
It flew three suborbital missions from Taiyuan LC-1 with two successes and a failure on the final mission. The first launch was on June 1, 1995 and the second one was in November 1997. The final and failed launch was on January 3, 2002.
    ...
    "Falcon 9": {
        ...
        "Operational Status":
            ...
            ''',
        "Number of Stages": "2",
        "Burn Time": "S1: 162 sec, S2: 397 sec",
        "total_burntime_int": 559,
        "Thrust": "S1: 7,607 kN, S2: 934 kN",
        "initial_thrust_int": 7607,
        "ISP": "S1: 282 sec, S2: 348 sec",
        "asl_isp_int": 282,
        "vac_isp_int": 348,
...
After the company had left Libya in 1987, some remaining equipment was confiscated by the government. However, enough parts and knowledge were missing to prevent Libya from continuing the project.
    ...
    "M-4S": {
        ...
        "Thrust": "Unknown",
        "initial_thrust_int": None,
        "ISP": "Boosters: 219 sec, S1: 219 sec, S2: Unknown, S3: Unknown, S4: Unknown",
        "asl_isp_int": 219,
        "vac_isp_int": 219,
        "Cost Per Launch": "Unknown",
        "cost_int": None,
        ...
        "Additional Information":
            ...
            in February from 1972 August was launched.
            '''
    },

    "Europa": {
        "Name": "Europa",
        "Agency": "ELDO (European Launcher Development Organisation)",
        "Manufacturer": "ELDO (European Launcher Development Organisation)",        
        "Class": "Light",
        "Payload Capacity to LEO":
            '''
        ...
        "Burn Time": "S1: 156 sec, S2: 96 sec, S3: 330 sec",
        "total_burntime_int": 582,
        "Thrust": "S1: 1672.67 kN, S2: 274.58 kN, S3: 23.3 kN",
        "initial_thrust_int": 1672.67,
        "ISP": "S1: 282 sec, S2: 277 sec, S3: 310 sec",
        "asl_isp_int": 282,
        "vac_isp_int": 310,
        "Cost Per Launch": "Unknown",
        "cost_int": None,
        "Fuel Type": "S1: RP-1/LOX, S2: UDMH/N2O4, S3: N2O4/Aerozine 50",
        "Total Launches": "11 (Blue Streak: 5, Blue Streak/Coralie: 2, Europa I: 3, Europa II: 1)",
        "total_launches_int": 11,
        "Successful Launches": "4 (Blue Streak: 4)",
        "successful_launches_int": 4,
        "Launch Failures": "7 (Blue Streak: 1, Blue Streak/Coralie: 2, Europa I: 3, Europa II: 1)",
        "failed_launches_int": 7,
        "Image": "europa.png",
        "Additional Information":
            '''
    ...
    "Vega": {
        ...
        "firstyear_int": 2012,        
        "Country": "Italy - EU",
        "flag_icon": "flags/italy.png",
        "Operational Status": "Active",
        "Number of Stages": "4",
        "Burn Time": "S1: 110 sec, S2: 77  sec, S3: 120 sec, S4: 667 sec",
        "total_burntime_int": 974,
        "Thrust": "S1: 2,261 kN, S2: 871 kN, S3: 260 kN, S4: 2.42 kN",
        "initial_thrust_int": 2261,
        "ISP": "S1: 280 sec, S2: 287.5 sec, S3: 296 sec, S4: 315.5 sec",
        "asl_isp_int": 280,
        "vac_isp_int": 315.5,
        "Cost Per Launch": "$37,000,000",
        "cost_int": 37000000,
        "Fuel Type": "S1: HTPB (solid), S2: HTPB (solid), S3: HTPB (solid), S4: UDMH/N2O4",
        "Total Launches": "15",
        "total_launches_int": 15,
        "Successful Launches": "14",
        "successful_launches_int": 14,
        "Launch Failures": "1",
        "failed_launches_int": 1,
        "Image": "vega.png",
        "Additional Information":
...
A L-27 cryogenic third stage, with 27 tons of propellant, using CE-20 engine.
    ...
    "Ariane 1": {
        ...
        "Operational Status": "Retired",
        "Number of Stages": "4",
        "Burn Time": "S1: 145 sec, S2: 132 sec, S3: 563 sec, S4: 50 sec",
        "total_burntime_int": 890,
        "Thrust": "S1: 2,771.9 kN, S2: 720.9 kN, S3: 61.6 kN, S4: 19.4 kN",
        "initial_thrust_int": 2771.9,
        "ISP": "S1: 281 sec, S2: 296 sec, S3: 443 sec, S4: 295 sec",
        "asl_isp_int": 281,
        "vac_isp_int": 369,
        "Cost Per Launch": "$77,056,059",
        "cost_int": 77056059,                
        "Fuel Type": "S1: N2O4/UDMH, S2: N2O4/UDMH, S3: LH2/LOX, S4: HTPB (solid)",
        "Total Launches": "11",
        "total_launches_int": 11,
    ...
    "Ariane 2": {
        ...
        "Operational Status": "Retired",
        "Number of Stages": "3",
        "Burn Time": "S1: 138 sec, S2: 128.9 sec, S3: 729 sec",
        "total_burntime_int": 995.9,
        "Thrust": "S1: 2,580 kN, S2: 784.8 kN, S3: 64.2 kN",
        "initial_thrust_int": 2580,
        "ISP": "S1: 242.2 sec, S2: 290.7 sec, S3: 442.1 sec",
        "asl_isp_int": 242.2,
        "vac_isp_int": 442.1,
        "Cost Per Launch": "Unknown",
        "cost_int": None,
        "Fuel Type": "S1: UH25/N2O4, S2: UH25/N2O4, S3: LH2/LOX",
        "Total Launches": "6",
    ...
    "Ariane 3": {
        ...
        "total_burntime_int": 1022.9,
        "Thrust": "Boosters: 1,260 kN, S1: 2,580 kN, S2: 784.8 kN, S3: 64.2 kN",
        "initial_thrust_int": 3840,
        "ISP": "Boosters: 235.9 sec, S1: 242.2 sec, S2: 290.7 sec, S3: 442.1 sec",
        "asl_isp_int": 239,
        "vac_isp_int": 442,
        "Cost Per Launch": "Unknown",
        "cost_int": None,
        "Fuel Type": "Boosters: CTPB (carboxy-terminated polybutadiene), S1: UH25/N2O4, S2: UH25/N2O4, S3: LH2/LOX",
        "Total Launches": "11",
        "total_launches_int": 11,
    ...
    "Ariane 4": {
        ...
        "total_burntime_int": 1238,
        "Thrust": "Boosters: 752 kN, S1: 3,034.1 kN, S2: 720.9 kN, S3: 62.7 kN",
        "initial_thrust_int": 3786.1,
        "ISP": "Boosters: 278 sec, S1: 278 sec, S2: 296 sec, S3: 446 sec",
        "asl_isp_int": 278,
        "vac_isp_int": 446,
        "Cost Per Launch": "$127,895,383",
        "cost_int": 127895383,
        "Fuel Type": "Boosters: N2O4/UDMH, S1: N2O4/UDMH, S2: N2O4/UDMH, S3: LH2/LOX",
        "Total Launches": "116 (40: 7, 42P: 15, 42L: 13)(44P: 15, 44LP: 26, 44L: 40)",
        "total_launches_int": 116,
        "Successful Launches": "113 (40: 7, 42P: 14, 42L: 13)(44P: 15, 44LP: 25, 44L: 39)",
        "successful_launches_int": 113,
        "Launch Failures": "3 (42P: 1, 44L: 1, 44LP: 1)",
        "failed_launches_int": 3,
        "Image": "Ariane 4.png",
        "Additional Information":
            '''
...
ES: Retired
            ''',
        "Number of Stages": "2",
        "Burn Time": "Boosters: 140 sec, Core: 540 sec, S2: 945 sec",
        "total_burntime_int": 1625,
        "Thrust": "Boosters: 14,160 kN, Core: 960 kN, S2: 67 kN",
        "initial_thrust_int": 15120,
        "ISP": "Boosters: 275 sec, Core: 310-432 sec(ASL-Vac), S2: 446",
        "asl_isp_int": 292.5,
        "vac_isp_int": 446,
        "Cost Per Launch": "$207,940,506",
        "cost_int": 207940506,
        "Fuel Type": "Boosters: AP, Aluminium, HTPB, Core: LH2/LOX, S2: LH2/LOX",
        "Total Launches": "109 (G: 16G+: 3GS: 6, ECA: 76ES: 8)",
        "total_launches_int": 109,
        "Successful Launches": "104 (G: 13G+: 3GS: 6, ECA: 74ES: 8)",
        "successful_launches_int": 104,
        "Launch Failures": "5 (Total: 2 (G: 1, ECA: 1), Partial: 3 (G: 2, ECA: 1))",
        "failed_launches_int": 5,
        "Image": "Ariane 5.png",
        "Additional Information":
            '''
...
It is often misunderstood that the M-3C rocket, M-3H rocket , M-3S rocket , and M-3SII rocket are guidance-controlled rockets, but the flight maneuver is similar to the L-4S rocket and M-4S rocket. This is the gravity turn method . The guidance control device mounted on these rockets merely corrects the deviation between the ideal flight path and the actual path set in advance by the launcher for the control in the vertical plane. After the combustion of the first stage and the second stage that flew according to the ideal path defined by the launcher was completed, the attitude was controlled by the side jet of the second stage and the spin was added by the spin motor to the third stage Flies inertially in a parabola, and starts combustion near its apex (Thrust error up to the second stage is corrected by controlling the launch direction and combustion start time of the third stage). It is from the MV rocket that the ISAS satellite launch rocket began to actively change the flight path in the vertical in-plane direction
    ...
    "M-3H" : {
        ...
        "Manufacturer": "The University of Tokyo Aerospace Research Institute, Nissan Aerospace",        
        "Class": "Light",
        "Payload Capacity to LEO": "300 kg (660 lbs)",
        "payload_int": 300,
        "Height": "23.8 m (78 ft)",
        "height_int": 23.8,
        "Diameter": "1.41 m (4ft 8 in)",
        "diameter_int": 1.41,       
        "Mass": "48,700 kg (107,000 lbs)",
        "mass_int": 48700,
        "Years in Operation": "1977-1978",
        "firstyear_int": 1977,
        "Country": "Japan",
        ...
        "Operational Status": "Retired",
        "Number of Stages": "3",
        "Burn Time": "Boosters: 5.5 sec, S1: 56 sec, S2: 55 sec, S3: 45 sec",
        "total_burntime_int": 156,
        "Thrust": "Boosters: 133 kN x 8, S1: 1,117 kN, S2: 357 kN, S3: 66.8 kN",
        "initial_thrust_int": 2150,
        "ISP": "Boosters: 219 sec, S1: 236 sec, S2: 277 sec, S3: 284 sec",
        "asl_isp_int": 228.5,
        "vac_isp_int": 284,
        "Cost Per Launch": "Unknown",
        "cost_int": None,
        "Fuel Type": "Boosters: UP-10, S1: BP-30B, S2: BP-22B, S3: BP-20B",
        "Total Launches": "3",
        "total_launches_int": 3,
        "Successful Launches": "3",
        "successful_launches_int": 3,
        ...
        "Additional Information":
            '''
The M-3H rocket (Mu3H) is manufactured by the Japan Aerospace Research Institute of the University of Tokyo (later the Institute of Space and Astronautical Science , Ministry of Education , now Space Aerospace Research Institute, hereinafter the University of Tokyo), Nissan Motor Aerospace Division. A three-stage solid fuel rocket for launching a scientific satellite that was jointly developed with (Nissan), manufactured by Nissan, and operated by the University of Tokyo.

The first stage of the M-3C rocket was extended to increase the launch capability. The final letter "C" of the M-3C is an acronym for "Control", which means guidance, whereas the final alphabet "H" of this rocket is taken from the acronym for "High Performance."

M-3C and M-3H have a lot in common in the structure, and both are considered together as the second generation of the Mu rocket. The M-3C was left behind after the M-3H appeared because it had to launch an alternative to the satellite that failed to launch, and as a result, the M-3H ended earlier in operation.
            '''
    ...
    "M-3S": {
        ...
        "Name": "Mu-3S",
        "Agency": "The University of Tokyo",
        "Manufacturer": "The University of Tokyo Aerospace Research Institute, Nissan Aerospace",        
        "Class": "Light",
...
Moon Express contracted Rocket lab to launch lunar landers (multiple launches contracted, some planned for Moon Express operations after GLXP) on an Electron to compete for the Google Lunar X Prize (GLXP). None of the contenders met the prize deadline, and the competition was closed without a winner. For sometime after the closure of GLXP, the Moon Express Electron launches remained scheduled, but before February 2020, all the launches of Moon Express using Electron were canceled.
    ...
    "Paektusan-1": {
        ...
        "firstyear_int": "",
        "Country": "North Korea",
        "flag_icon": "flags/northkorea.png",
        "Operational Status": "",
        "Number of Stages": "",
        "Burn Time": "",
        "total_burntime_int": "",
...
Stage 3 contains a motor named Mizar-B.
    ...
    "Zenit 3SLB": {
        ...
        "Operational Status": "Active",
        "Number of Stages": "3",
        "Burn Time": "S1: 150 sec, S2: 370 sec, S3: 350 sec",
        "total_burntime_int": 870,
        "Thrust": "S1: 7,257 kN, S2: 912 kN, S3: 84.9 kN",
        "initial_thrust_int": 7257,
        "ISP": "S1: 309.5 sec, S2: 350 sec, S3: 352 sec",
        "asl_isp_int": 309.5,
        "vac_isp_int": 352 ,
        "Cost Per Launch": "$137,561,556",
        "cost_int": 137561556,
        "Fuel Type": "S1: RP-1/LOX, S2: RP-1/LOX, S3: RP-1/LOX",
        "Total Launches": "6",
        "total_launches_int": 6,
        "Successful Launches": "6",
        "successful_launches_int": 6,
