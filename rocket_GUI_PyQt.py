...
# Form implementation generated from reading ui file '.\rocket_GUI_PyQt.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_3.setMaximumSize(QtCore.QSize(260, 50))
        ...
        self.searchHeaderLabel = QtWidgets.QLabel(self.frame_3)
        self.searchHeaderLabel.setMaximumSize(QtCore.QSize(80, 16777215))
        self.searchHeaderLabel.setObjectName("searchHeaderLabel")
        self.horizontalLayout_3.addWidget(self.searchHeaderLabel)
        ...
        self.gridLayout.addWidget(self.frame, 6, 0, 4, 6)
        self.frame_2 = QtWidgets.QFrame(self.centralwidget)
        self.frame_2.setMinimumSize(QtCore.QSize(0, 146))
        ...
        self.rocketHeaderLabel = QtWidgets.QLabel(self.frame_2)
        self.rocketHeaderLabel.setMaximumSize(QtCore.QSize(260, 50))
        self.rocketHeaderLabel.setObjectName("rocketHeaderLabel")
        self.horizontalLayout_2.addWidget(self.rocketHeaderLabel)
        self.informationHeaderLabel = QtWidgets.QLabel(self.frame_2)
        ...
        self.horizontalLayout_2.addWidget(self.informationHeaderLabel)
        self.imageHeaderLabel = QtWidgets.QLabel(self.frame_2)
        self.imageHeaderLabel.setMaximumSize(QtCore.QSize(600, 50))
        self.imageHeaderLabel.setObjectName("imageHeaderLabel")
        self.horizontalLayout_2.addWidget(self.imageHeaderLabel)
        self.gridLayout.addWidget(self.frame_2, 4, 0, 1, 6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.searchHeaderLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Search</span></p></body></html>"))
        ...
        self.rocketHeaderLabel.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:24pt; font-weight:600;\">Rockets</span></p></body></html>"))
        self.informationHeaderLabel.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:24pt; font-weight:600;\">Information</span></p></body></html>"))
        self.imageHeaderLabel.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:24pt; font-weight:600;\">Image</span></p></body></html>"))
